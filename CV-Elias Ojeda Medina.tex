...
\end{minipage}
\begin{minipage}[t]{0.295\textwidth} % 27.5% of the page width for the first row of icons
	\vspace{-\baselineskip} % Required for vertically aligning minipages
	
	\icon{MapMarker}{12}{Ciudad de México, México}\\
	\icon{At}{12}{\href{mailto:hi@eliasojedamedina.com}{dev@eliasojedamedina.com}}\\
...
\begin{center}
	\bubbles{5/Creativo, 6/Puntual, 4/Proactivo, 5/Equipo, 4/Organizado}
\end{center}
